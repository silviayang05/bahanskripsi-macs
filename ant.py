...
class Ant:
    ...
    def insertion_procedure(self, stop_event: Event, max_iterations: int):
        """
        Untuk setiap node yang belum dikunjungi, coba temukan posisi yang sesuai untuk dimasukkan ke travel_path saat ini.
        Posisi yang dimasukkan tidak boleh melanggar batasan beban, waktu, dan jarak tempuh.
        :return:
        """
        ...
        iterations = 0
        while success_to_insert and iterations < max_iterations:
    ...
    def local_search_procedure(self, stop_event: Event, max_iterations: int):
        """
        Lakukan pencarian lokal pada travel_path yang telah mengunjungi semua node dalam graph.
        :return:
        """
